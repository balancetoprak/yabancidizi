  ...
  if (!isEmpty(trailers)) {
    return (
      <>
        ...
        <Modal backdrop="blur" size="5xl" isOpen={opened} onClose={handleClose} placement="center" className="bg-background">
          <ModalContent>
                  ...
                  <div className="embla__container gap-2">
                    {trailers.map((trailer, index) => {
                      ...
                      return (
                        <div
                          key={trailer.key}
                          className="embla__slide rounded-large flex aspect-video size-full items-center px-1 py-2"
                        >
                          <Skeleton className="rounded-large size-full" />
                          {inView && (
                            <iframe
                              className="rounded-large absolute z-10 size-full"
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          className={cn("bg-foreground size-2 rounded-full transition-all", {
