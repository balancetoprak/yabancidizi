...
const TvShowPlayerHeader: React.FC<TvShowPlayerHeaderProps> = ({
  ...
  return (
    ...
    >
      <ActionButton label="Geri" href={`/tv/${id}`}>
        <ArrowLeft size={42} />
      </ActionButton>
      ...
      <div className="flex items-center gap-4">
        ...
        <ActionButton label="Sağlayıcılar" tooltip="Sağlayıcılar" onClick={onOpenSource}>
          <Server size={34} />
        </ActionButton>
        <ActionButton label="Bölümler" tooltip="Bölümler" onClick={onOpenEpisode}>
          <List size={34} />
        </ActionButton>
      </div>
    </div>
